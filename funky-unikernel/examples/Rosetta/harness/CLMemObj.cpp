...
namespace rosetta
{
  ...
  CLMemObj::CLMemObj(void *mem_data, int elt_size, int length, cl_mem_flags flags, void* xil_ext ) 
  {
    ...
    if(xil_ext)
      printf("[%s] Warning: Funky does not support OpenCL Xilinx extension.\n", __func__);
  ...
  void* CLMemObj::get_xil_ext_ptr() { return bank; }
}
