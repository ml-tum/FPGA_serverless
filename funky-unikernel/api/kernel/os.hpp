...
public:
  ...
  **/
  ...
  static const char* get_cli_ip4() noexcept;
  static const char* get_cli_gw() noexcept;
  static const char* get_cli_nmsk() noexcept;
  static const char *store_net_config(const char *cli);
  ...
  /**
   *  Remove handler for standard output.
   */
  static void remove_stdout();
  //static void remove_stdout(print_func func);
...
private:
  ...
  static const char* cli_ip4;
  static const char* cli_gw;
  static const char* cli_nmsk;
