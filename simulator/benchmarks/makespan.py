...
if __name__ == "__main__":
    ...
    with open("characterized_benchmark_results_20231125154634.json", "r") as f:
        results = json.load(f)
    ...
    grouped_df = df.groupby(['characterized_functions', 'scheduler_weights'])['makespan'].mean().reset_index()
    ...
    plt.title('Difference in Makespan by Characterized Functions and Scheduler Weights')

    # Show the plot
    plt.show()

    # TODO Create proper graphs for evaluation section
