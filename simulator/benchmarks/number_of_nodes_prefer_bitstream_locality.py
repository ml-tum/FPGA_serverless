...
if __name__ == "__main__":
    ...
    results = []
    with open("number_of_nodes_benchmark_results_20230703184900.json", "r") as f:
        results = json.load(f)
    ...
    tbl.to_latex(
        buf='../../../figures/number_of_nodes_prefer_bitstream_locality.tex',
    ...
    def plot():
        ...
        ax1.set_ylabel('FPGA utilization')
    ...
    plot()
    plt.savefig('../../../figures/number_of_nodes_prefer_bitstream_locality.png', dpi=300)
